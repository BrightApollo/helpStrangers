/*
1. A real-estate developer wants to estimate the cost of each apartment on each floor
of his development before he starts marketing them. He has decided to quote different
prices for apartments on different floors.

The price for all apartments on the first floor is a sum of
    their base price,
    charges on amenities,
    and taxes.
...
apartment on the second floor would have a base price of $663,000.
...
Your program asks for
    ...
    the base price of apartments on the first floor,
    and the rates (as a decimal) of the charges on amenities,
    and taxes.
...
The program should output
    ...
    charges on amenities,
    taxes,
    and the total price of apartments on each floor. (Hint: Use a loop.)
